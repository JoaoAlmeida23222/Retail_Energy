...
import LogoVendedor from "../recursos/Logotipo_Vendedor.svg";
    ...
    <>
      ...
      >
        <div className="d-flex flex-column">
          <div className="mt-3">
            <img width="290" src={LogoVendedor} alt="LogoRT" />
          ...
          <nav className="nav-menu-vendedor text-light">
            <ul>
              <li>
                <Link to="/home_vendedor" className="nav-link">
                  <i className="fa-solid fa-home"></i>
                  Início
                </Link>
              </li>
              <li>
                <Link to="/editar_perfil_vendedor" className="nav-link">
                  <i className="fa-solid fa-user-pen"></i>
                  Editar perfil
                </Link>
              </li>
              <li>
                <Link to="/efetuar_venda" className="nav-link">
                  <i className="fa-solid fa-cart-plus"></i>
                  Efetuar venda
                </Link>
              </li>
              <li>
                <Link to="/consultar_transacoes_vendedor" className="nav-link">
